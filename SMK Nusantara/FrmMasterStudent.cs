...
{
    public partial class FrmMasterStudent : Form
    {
        private Form close;
        ...
        public FrmMasterStudent(Form close)
        {
            InitializeComponent();
            this.close = close;
        }
        ...
        private void autoNumber()
        {
            ...
            {
                Student s = db.Students.OrderByDescending(u => u.StudentID).FirstOrDefault();
                if (s != null)
                {
                    string a = s.StudentID.ToString().Substring(4, 4);
        ...
        private void FrmMasterStudent_Load(object sender, EventArgs e)
        {
            awal();
            txtID.Enabled = false;
        }

        private void FrmMasterStudent_FormClosed(object sender, FormClosedEventArgs e)
        {
            close.Show();
            this.Hide();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                using (DataClasses1DataContext db = new DataClasses1DataContext())
                {
                    ...
                    {
                        MessageBox.Show("Ensure the age student must be between 15 and 21 years", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
